    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateTotalAmount() {
                var updatedAmounts = Array.from(amount).map(function (cell, index) {
                    return productCheckboxes[index].checked ? parseFloat(cell.textContent.replace('₱', '')) : 0;
                });

                var overallTotal = updatedAmounts.reduce(function (total, amount) {
                    return total + amount;
                }, 0);

                overallAmountElement.textContent = 'Total: ₱' + overallTotal.toFixed(2);
            }
        });
        ...
        document.getElementById('dropdownVariations').textContent = 'Variations: ' + variation;
    ...
    function selectAllProducts() {
        ...
        function updateTotal() {
            ...
            checkboxes.forEach(function (checkbox) {
                ...
                var price = parseFloat(row.querySelector('.unit-price h5').textContent.replace('₱', ''));
